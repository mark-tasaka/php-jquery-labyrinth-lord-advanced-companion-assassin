...
<html>
<head>
<title>Launch Page: Labyrinth Lord Assassin Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="assassinForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Assassin</option>
				<option value="2">2nd Level, Assassin</option>
				<option value="3">3rd Level, Assassin</option>
				<option value="4">4th Level, Assassin</option>
				<option value="5">5th Level, Assassin</option>
				<option value="6">6th Level, Assassin</option>
				<option value="7">7th Level, Assassin</option>
				<option value="8">8th Level, Assassin</option>
				<option value="9">9th Level, Assassin</option>
				<option value="10">10th Level, Assassin</option>
				<option value="11">11th Level, Assassin</option>
				<option value="12">12th Level, Assassin</option>
				<option value="13">13th Level, Assassin</option>
				<option value="14">14th Level, Assassin</option>
				<option value="15">15th Level, Assassin</option>
			  </select>
            ...
            <br/>
			  ...
			  <select id="chracterRace" name="theCharacterRace" class="alignmentBox">	
				...
				<option value="Gnome">Gnome (8)*</option>
				<option value="Half-Elf">Half-Elf (11)*</option>
				<option value="Half-Orc">Half-Orc (Unlimited)</option>
			  </select>
                
               <p><span class="footnote2">&#42;Maximum demi-human assassin level.</span></p>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#assassinForm").attr('action', "character/ll_assassin_"+ $("#abilityScores").val() +  ".php");
