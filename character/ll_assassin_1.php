...
<html>
<head>
<title>Labyrinth Lord Assassin Character Generator</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Labyrinth Lord Assassin Character Generator. Goblinoid Games.">
	<meta name="keywords" content="Labyrinth Lord, Goblinoid Games,HTML5,CSS,JavaScript">
	<meta name="author" content="Mark Tasaka 2018">
		

	<link rel="stylesheet" type="text/css" href="css/ll_assassin.css">
	<link rel="stylesheet" type="text/css" href="css/ll_assassin_post.css">
...
<body>
    ...
    $totalWeightCarried = $totalArmourWeight + $totalWeaponWeight + $totalGearWeight;
    ...
    $thiefHearNoise = hearNoise ($level, $characterRace);
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
      ...
      <span id="primeReq"></span>
       ...
       <span id="thiefSkillsAssassin">
           <?php
           
           if($level >2)
           {
            echo "THIEF SKILLS:<br/> Pick Locks " .  ($thiefPickLocks + $raceAdjustPickLocks) . "%;
             Find & Remove Traps " . ($thiefFindRemoveTraps + $raceAdjustFindRemoveTraps ) . "%; Pick Pockets "
                . ($thiefPickPockets + $raceAdjustPickPockets) . "%;<br/> Move Silently "
                . ($thiefMoveSilent + $raceAdjustMoveSilently) . "%; Climb Walls "
                . ($thiefClimbWalls + $raceAdjustClimbWalls) . "%; Hide in Shadows "
                . ($thiefHideInShadows + $raceAdjustHideShadows) . "%; Hear Noise "
                . ($thiefHearNoise);
           }
           ?>
       </span>
  ...
  <script>
	...
	/*
	 Character() - Assassin Character Constructor
	*/
	function Character() {
        
        let strengthBase = <?php echo rand(12, 18) ?>;
        let strength = demiHumanStrength('<?php echo $characterRace ?>', strengthBase);
        let dexterityBase = <?php echo rand(12, 18) ?>;
        ...
        let	intelligenceBase = <?php echo rand(12, 18) ?>;
	    ...
	    if(assassinCharacter.hitPoints <= 0 ){
			assassinCharacter.hitPoints = 1;
		}
		return assassinCharacter;
       ...
       let imgData = "images/assassin_character_sheet.png";
